...
/// A tall gradient row: a title, a chevron, and a whole band of colour.
///
/// This is the shape a list of categories wants. A flat chip list of thirty
/// traditions is a wall of identical pills that the eye cannot enter; giving
/// each row the full width and its own band of the ramp turns the same list
/// into something a reader can scan and remember a position in.
class GradientRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GradientCard(
      ...
      sheenAlignment: const Alignment(-0.9, -1),
      child: Row(
        children: <Widget>[
          Expanded(
            child: Column(
